...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','analytics.google.js')
	...
	f = os.path.join(cwd,'Classes','AnalyticsGoogleModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','analytics.google.js']
